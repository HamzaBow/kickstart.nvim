...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>di', vim.diagnostic.setloclist, { desc = 'Open diagnostic [Q]uickfix list' })
...

  {
    ...
    config = function()
      require('nvim-ts-autotag').setup {
        ...
        filetypes = {
          html = { enable_close = false }, -- Override for specific filetypes
        },
        did_setup = function() end,
        setup = function() end,
        get_opts = function() end,
      }
    end,
  },
}, {
